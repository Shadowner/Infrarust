...
use crate::types::{
    Boolean, ByteArray, Long, ProtocolRead, ProtocolString, ProtocolUUID, ProtocolWrite,
};
use crate::version::Version;

// Define ProtocolResult type for this crate
pub type ProtocolResult<T> = Result<T, io::Error>;
