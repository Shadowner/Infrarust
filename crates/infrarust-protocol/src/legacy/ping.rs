...
fn build_kick_packet(payload: &str) -> Vec<u8> {
...
impl LegacyPingResponse {
    ...
    pub fn build_beta_response(&self) -> Vec<u8> {
        let payload = format!(
            "{}§{}§{}",
    ...
    pub fn build_v1_4_response(&self) -> Vec<u8> {
        let payload = format!(
            "\u{00a7}1\0{}\0{}\0{}\0{}\0{}",
...
mod tests {
    ...
    fn test_build_beta_response() {
        ...
        let bytes = resp.build_beta_response();
    ...
    fn test_build_v1_4_response() {
        ...
        let bytes = resp.build_v1_4_response();
