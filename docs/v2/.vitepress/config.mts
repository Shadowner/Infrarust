    ...
    themeConfig: {
      ...
      sidebar: {
        ...
        '/plugins/': [
          ...
          {
            text: 'Developing WASM Plugins',
            collapsed: false,
            items: [
              { text: 'Overview', link: '/plugins/wasm/' },
              ...
              { text: 'Threading & Concurrency', link: '/plugins/wasm/threading' },
              ...
              { text: 'Plugin Messaging', link: '/plugins/wasm/messaging' },
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Threading Model', link: '/plugins/dev/threading' },
              ...
              { text: 'Migrating from 2.0.0-beta.3', link: '/plugins/dev/migration' },
            ],
          },
        ],
        '/reference/': [
